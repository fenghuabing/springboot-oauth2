...
-- ----------------------------
BEGIN;
INSERT INTO `oauth_client_details` VALUES  ('client', 'oauth2-resource', 'secret', 'app', 'authorization_code', '', null, null, null, null, null), ('trusted-client', 'oauth2-resource', null, 'read', 'authorization_code', null, null, null, null, null, '');
COMMIT;
